...
namespace MvcFPTBook.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(MvcBookContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.OrderDetail != null ? 
                          ...
                          Problem("Entity set 'MvcBookContext.OrderDetail'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcBookContext.OrderDetail'  is null.");
            }
            var orderDetail = await _context.OrderDetail.FindAsync(id);
            if (orderDetail != null)
            {
